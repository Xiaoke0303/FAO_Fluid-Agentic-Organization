...
> 白皮书引用卡与外部参考材料。不是 FAO proof，不等于已被白皮书正文吸收。

## 状态标记

- raw：原始材料，未消化
- unabsorbed：已读，尚未吸收进主文
- needs re-read：需重读或复核
- absorbed：已吸收进白皮书或 framework
...
*本目录存放白皮书级参考材料，含结构化引用卡和较长外部研究笔记。*
*入此目录不等于已被白皮书正文或 framework 吸收。*
*吸收需经明确审核与状态更新。*
